import { componentCatalog } from './config.js';
 ...
 * @param {number} typeId
 * @param {number} targetColumn - Target column number (1, 2, 3, or 4). Tab number equals column number.
 */
export function addComponentInstance(typeId, targetColumn) {
